...
<body class="font-sans bg-background min-h-screen flex items-center justify-center px-4">
    ...
    <div class="flex flex-col items-center text-center max-w-md w-full">
        ...
        {{-- Illustration --}}
        <div class="w-24 h-24 rounded-3xl bg-error-lightest flex items-center justify-center mb-8">
        ...
        {{-- Error code --}}
        <p class="text-8xl font-bold text-error mb-2 leading-none">500</p>

        {{-- Heading --}}
        <h1 class="text-xl font-semibold text-text-primary mb-3">Something went wrong</h1>
