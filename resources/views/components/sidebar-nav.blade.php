@php
    ...
    $navItems = [
        ...
        [
            ...
            'activeRoutes' => ['tenant.settings.academic-year', 'tenant.settings.classes', 'tenant.settings.subjects'],
            'icon'        => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"/>',
        ],
        [
            'label'      => 'Attendance',
        ...
        [
            'label'      => 'Assignments',
            'route'      => 'tenant.assignments.index',
            'path'       => '/assignments',
        ...
        [
            ...
            'exclude'      => ['tenant.settings.classes', 'tenant.settings.subjects', 'tenant.settings.academic-year'],
    ...
    @foreach ($navItems as $item)
        ...
        @if ($visible)
            @php
                ...
                $extraActive   = !empty($item['activeRoutes']) && request()->routeIs($item['activeRoutes']);
                $isActive      = !$excluded && ($extraActive || request()->routeIs($item['route']) || request()->routeIs($activePattern));
