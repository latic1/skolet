...
<title>Report Card &mdash; {{ $student->full_name }}</title>
<style>
...
<div class="header">
    ...
    <div class="report-title">
        ...
        <p>{{ $exam->start_date->format('d M Y') }} &ndash; {{ $exam->end_date->format('d M Y') }}</p>
        @endif
    </div>
</div>
...
<div class="watermark">
    Generated by Skolet &middot; {{ now()->format('d M Y, H:i') }}
</div>
