...
<div class="flex flex-col gap-6 max-w-3xl">
    ...
    <div class="flex items-center gap-2 text-sm text-text-muted">
        ...
        <span class="text-text-primary font-medium">Add Staff Member</span>
    </div>
    ...
    <form method="POST" action="{{ $host }}/staff" class="flex flex-col gap-6"
        ...
        <div class="bg-surface border border-border rounded-2xl shadow-card p-6 flex flex-col gap-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="role_title" value="{{ old('role_title') }}"
                    ...
                    <p class="mt-1 text-xs text-text-muted">Their job title within the school (optional)</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <select name="system_role" required
                        ...
                        <option value="{{ $role->name }}" @selected(old('system_role') === $role->name)>
